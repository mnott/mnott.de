...
In other words, there is a [Git plugin for Wordpress](https://www.aakashweb.com/docs/git-it-write/faq/). You can install it just as a Wordpress plugin. It is actually very well documented. You can also look at its [Github Page](https://github.com/vaakash/git-it-write). Essentially, you do this:
